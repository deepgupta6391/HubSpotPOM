...
public class ContactsPage extends BasePage {
	...
	By contactsNavigate = By.xpath("(//i18n-string[text()='Contacts'])[position()=1]");
	By actionsForContacts = By.xpath("//span[text()='Actions']");
	...
	public void createSingleContact(String mail, String FN, String LN, String jobtitle) {
	...
	public void createMultipleContacts(String mail, String FN, String LN, String jobtitle) {
		createSingleContact(mail, FN, LN, jobtitle);
		jsUtil.checkPageIsReady();
		elementUtil.waitForElementPresent(actionsForContacts);
		elementUtil.doClick(contactsNavigate);
	}
